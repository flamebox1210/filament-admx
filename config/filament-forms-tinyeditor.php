...
return [
    ...
    */
    ...
    'profiles' => [
        ...
        'default' => [
            'plugins' => 'advlist autoresize codesample emoticons fullscreen hr image imagetools link lists media table toc wordcount',
            'toolbar' => 'formatselect fontsizeselect | removeformat bold italic underline | alignjustify alignright aligncenter alignleft | numlist bullist | forecolor backcolor | blockquote table hr | image link media codesample emoticons | wordcount fullscreen',
